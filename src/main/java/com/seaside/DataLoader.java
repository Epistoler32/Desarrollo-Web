    ...
    public void run(String... args) throws Exception {
        ...
        if (productoRepository.count() == 0) {
            ...
            productoRepository.save(new Producto(null, "Arroz Marinero Especial",
                    "Arroz preparado con camarones, calamares y especias que resaltan el sabor del mar.", 58000.0,
                    platosFuertes,
            ...
            productoRepository.save(new Producto(null, "Langosta Thermidor",
                    ...
                    50, true));
            productoRepository.save(new Producto(null, "Atún Sellado", "Lomo de atún sellado con ajonjolí y soya.",
            ...
            productoRepository.save(new Producto(null, "Picada Marina SeaSide",
                    "Selección de mariscos fritos, ideal para compartir.", 76000.0, entradas,
            ...
            productoRepository.save(new Producto(null, "Porción de Arroz de Coco",
                    ...
                    10, true));
            productoRepository.save(new Producto(null, "Yucas Fritas", "Bastones de yuca con suero costeño.", 12000.0,
                    acompanamientos,
            ...
            productoRepository.save(new Producto(null, "Flan", "Postre tradicional de huevo y caramelo.", 12000.0,
                    postres,
            ...
            productoRepository.save(new Producto(null, "Agua Fresca", "Bebida refrescante de frutas naturales.", 8000.0,
                    bebidas,
                    "https://image2url.com/r2/default/images/1772555111888-fe47c4ba-0974-44af-ad0d-6490c14db4c4.png", 5,
                    true));
            ...
            productoRepository.save(new Producto(null, "Soda Saborizada",
                    ...
                    "https://image2url.com/r2/default/images/1772555008586-f2cd19fa-2689-4cf5-a679-3e0675393bb7.png", 5,
                    true));
            productoRepository.save(new Producto(null, "Té Helado de la Casa",
                    ...
                    "https://image2url.com/r2/default/images/1772554958625-4340a022-ae7d-4e25-ac87-b41bc59dd81c.png", 5,
                    true));
            productoRepository.save(new Producto(null, "Café Espresso / Americano",
                    ...
                    "https://image2url.com/r2/default/images/1772554945245-052c7691-d361-4e59-8f51-09a271e5d08c.png", 5,
                    true));
