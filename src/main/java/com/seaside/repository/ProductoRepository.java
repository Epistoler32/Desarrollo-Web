...
public class ProductoRepository {
        ...
        public ProductoRepository() {
                ...
                productos.put(3, new Producto(3, "Picada Marina SeaSide",
                                "Selección de mariscos fritos, ideal para compartir.", 76000.0, "platos_fuertes",
                ...
                productos.put(5, new Producto(5, "Atún Sellado", "Lomo de atún sellado con ajonjolí y soya.", 64000.0,
                                "platos_fuertes",
                ...
                productos.put(6, new Producto(6, "Pulpo a la Parrilla",
                                "Pulpo tierno con aceite de oliva y pimentón ahumado.", 69000.0, "platos_fuertes",
